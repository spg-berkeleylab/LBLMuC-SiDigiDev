...
SIM.outputFile = "protonGun_sim_MuColl_v1.slcio"
...
#Parameter for reaching below the minimum ionization area
BETA_GAMMA = 0.5
MASS_PROTON = 1*GeV
P_NEEDED = BETA_GAMMA * MASS_PROTON
SIM.gun.energy = sqrt(P_NEEDED**2 + MASS_PROTON**2)
